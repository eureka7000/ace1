...
class CodesControllerTest < ActionController::TestCase
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post :create, code: { category: @code.category, code_name: @code.code_name, use_yn: @code.use_yn }
    end
  ...
  test "should update code" do
    patch :update, id: @code, code: { category: @code.category, code_name: @code.code_name, use_yn: @code.use_yn }
    assert_redirected_to code_path(assigns(:code))
  end
