...
class SubCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create sub_category" do
    assert_difference('SubCategory.count') do
      post :create, sub_category: { category_id: @sub_category.category_id, code: @sub_category.code, name: @sub_category.name }
    end
  ...
  test "should update sub_category" do
    patch :update, id: @sub_category, sub_category: { category_id: @sub_category.category_id, code: @sub_category.code, name: @sub_category.name }
    assert_redirected_to sub_category_path(assigns(:sub_category))
  end
