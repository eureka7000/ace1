class Teacher < ActiveRecord::Base
    ...
    def self.get_students(school_id, page, teacher_name, student_name, order)
        ...
        query = "select tc.user_name as teacher_name, e.user_id as teacher_id, stu.user_name as student_name, stu.id as student_id, stu.email as student_email, stu.sign_in_count, stu.created_at
